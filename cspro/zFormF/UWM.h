...
namespace UWM::Form
{
    ...
    const unsigned UpdateCapiLanguages         = UWM::Ranges::FormStart + 11;
    const unsigned ShowCapiText                = UWM::Ranges::FormStart + 12;
    const unsigned CapiMacros                  = UWM::Ranges::FormStart + 13;
