...
public:
    ...
    int     DisplayMessage(MessageType message_type, const RuntimeMessage& runtime_message) override;
    int     DisplayMessage_pre77(MessageType message_type, const RuntimeMessage& runtime_message);
