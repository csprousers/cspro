...
public:
    ...
    [[nodiscard]] virtual std::string dvaltochar(double value, bool convert_number_from_engine_format) const; // INTERPRETER_DLL_TODO marked as virtual only so that it is accessible from zEngineO
