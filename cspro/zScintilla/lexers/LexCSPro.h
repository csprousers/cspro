...
public:
    static constexpr const char* Name(int language)
    {
        return ( language == SCLEX_CSPRO_LOGIC_V0 )             ? "csprologic_v0" :
               ...
               ( language == SCLEX_CSPRO_REPORT_V0 )            ? "csprotexttemplate_v0" :
               ( language == SCLEX_CSPRO_REPORT_V8_0 )          ? "csprotexttemplate" :
               ( language == SCLEX_CSPRO_REPORT_HTML_V0 )       ? "csprotexttemplatehtml_v0" :
               ( language == SCLEX_CSPRO_REPORT_HTML_V8_0 )     ? "csprotexttemplatehtml" :
               ( language == SCLEX_CSPRO_REPORT_MARKDOWN_V0 )   ? "csprotexttemplatemarkdown_v0" :
               ( language == SCLEX_CSPRO_REPORT_MARKDOWN_V8_0 ) ? "csprotexttemplatemarkdown" :
