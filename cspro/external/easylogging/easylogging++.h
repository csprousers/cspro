...
extern ZNETWORK_API base::type::StoragePointer elStorage;
...
return *this;\
  ...
  ZNETWORK_API MessageBuilder& operator<<(const wchar_t* msg);
...
class Writer : base::NoCopy {
 public:
  ZNETWORK_API Writer(Level level, const char* file, base::type::LineNumber line,
  ...
  ZNETWORK_API Writer& construct(int count, const char* loggerIds, ...);
 protected:
  LogMessage* m_msg;
  Level m_level;
  const char* m_file;
  ...
  ZNETWORK_API void processDispatch();
