...
// "static restrict" uses were replaced with "static_restrict"
...
static void SHA256_Transform(uint32_t state[static_restrict 8],
    const uint8_t block[static_restrict 64], uint32_t W[static_restrict 64],
    uint32_t S[static_restrict 8]);
#else
static void SHA256_Transform(uint32_t[static_restrict 8],
    const uint8_t[static_restrict 64], uint32_t[static_restrict 64],
    uint32_t[static_restrict 8]);
#endif
...
static void
SHA256_Transform_shani_with_W_S(uint32_t state[static_restrict 8],
    const uint8_t block[static_restrict 64], uint32_t W[static_restrict 64],
    uint32_t S[static_restrict 8])
{
...
static void
SHA256_Transform_arm_with_W_S(uint32_t state[static_restrict 8],
    const uint8_t block[static_restrict 64], uint32_t W[static_restrict 64],
    uint32_t S[static_restrict 8])
{
