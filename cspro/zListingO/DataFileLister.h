...
namespace Listing { class DataFileLister; }


class Listing::DataFileLister : public Lister
{
public:
    DataFileLister(std::shared_ptr<ProcessSummary> process_summary, const std::string& file_path, bool append, std::shared_ptr<const CaseAccess> case_access);
    ~DataFileLister();
