...
namespace cs { template<typename T> class shared_or_raw_ptr;
               template<typename T> class non_null_shared_or_raw_ptr; }


// --------------------------------------------------------------------------
// cs::shared_or_raw_ptr
//
...
template<typename T>
class cs::non_null_shared_or_raw_ptr : public shared_or_raw_ptr<T>
{
public:
#ifdef _DEBUG
    template<typename RT>
...
#else
    using ParentType = shared_or_raw_ptr<T>;
