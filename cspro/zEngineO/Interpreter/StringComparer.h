...
namespace EngineStringComparer
{
    ...
    namespace V0
    {
        int Compare(const char* lhs_itr, const char* rhs_itr);
        int Compare(const std::string& lhs_text, const std::string& rhs_text);
        bool Evaluate(const std::string& lhs_text, const std::string& rhs_text, TokenCode token_code);
    }

    namespace V8
    {
        template<TokenCode token_code>
        bool Evaluate(const std::string& lhs, const std::string& rhs);

        bool Evaluate(const std::string& lhs, const std::string& rhs, TokenCode token_code);
    }
}
...
inline constexpr TokenCode EngineStringComparer::NumericFunctionCodeToTokenCode(const FunctionCode function_code)
{
...
inline constexpr TokenCode EngineStringComparer::StringFunctionCodeToTokenCode(const FunctionCode function_code)
{
...
inline int EngineStringComparer::V0::Compare(const char* lhs_itr, const char* rhs_itr)
{
...
inline int EngineStringComparer::V0::Compare(const std::string& lhs_text, const std::string& rhs_text)
{
    return Compare(lhs_text.c_str(), rhs_text.c_str());
}


inline bool EngineStringComparer::V0::Evaluate(const std::string& lhs_text, const std::string& rhs_text, const TokenCode token_code)
{
...
template<TokenCode token_code>
bool EngineStringComparer::V8::Evaluate(const std::string& lhs, const std::string& rhs)
{
...
inline bool EngineStringComparer::V8::Evaluate(const std::string& lhs, const std::string& rhs, const TokenCode token_code)
{
