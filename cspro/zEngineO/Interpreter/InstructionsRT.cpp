...
/* 349 */   OP(ex_SystemApp_exec),
/* 350 */   OP(ex_startswith),
/* 351 */   OP(ex_Pff_compute),
/* 352 */   OP(ex_Audio_clear),
/* 353 */   OP(ex_Audio_concat),
/* 354 */   OP(ex_Audio_load),
/* 355 */   OP(ex_Audio_play),
/* 356 */   OP(ex_Audio_save),
/* 357 */   OP(ex_Audio_stop),
/* 358 */   OP(ex_Audio_record),
/* 359 */   OP(ex_Audio_recordInteractive),
/* 360 */   OP(ex_Audio_compute),
/* 361 */   OP(ex_encode),
/* 362 */   OP(ex_List_sort),
...
/* 374 */   OP(ex_HashMap_contains),
/* 375 */   OP(ex_HashMap_length),
/* 376 */   OP(ex_HashMap_remove),
/* 377 */   OP(ex_HashMap_getKeys),
/* 378 */   OP(ex_Audio_length),
