...
LOCAL_SRC_FILES         += $(ZACTION_SRC_PATH)/Exception.cpp
...
LOCAL_SRC_FILES         += $(ZACTION_SRC_PATH)/Network.cpp
...
LOCAL_SRC_FILES         += $(ZACTION_SRC_PATH)/Sync.cpp
...
LOCAL_STATIC_LIBRARIES  := zPlatformO zSql zToolsO zJson zUtilO zHtml zMessageO zNetwork zUtilF zDictO zFormO zAppO zParadataO zDataO zLogicO
