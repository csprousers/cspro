...
LOCAL_SRC_FILES         += $(ZUTILO_SRC_PATH)/BinaryContentCacher.cpp
...
LOCAL_SRC_FILES         += $(ZUTILO_SRC_PATH)/SettingsDb.cpp
...
LOCAL_SRC_FILES         += $(ZUTILO_SRC_PATH)/SyncConnectionString.cpp
...
LOCAL_STATIC_LIBRARIES  := zPlatformO zSql zJson
