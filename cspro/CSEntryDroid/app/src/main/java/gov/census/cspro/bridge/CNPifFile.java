...
public class CNPifFile
{
    ...
    public boolean ShouldShowInApplicationListing(boolean showHiddenApplications)
    {
        ...
        return (!description.trim().isEmpty()) && ( ( showInApplicationListing == ShowInApplicationListing.Always ) ||
    ...
    public native static String CreatePffFromDeepLinkUrl(String url);
}
