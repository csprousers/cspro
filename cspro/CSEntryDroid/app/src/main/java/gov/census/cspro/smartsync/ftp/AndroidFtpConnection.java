...
public class AndroidFtpConnection {
    ...
    public void download(String remoteFilePath, String localFilePath) throws IllegalStateException, IOException, FTPIllegalReplyException, FTPException, FTPDataTransferException, SyncCancelException  {
        ...
        if (listener != null && listener.getTotal() <= 0)
        ...
        Timber.i("Finished download cancel = %b", listener != null && listener.isCanceled());
        if (listener != null && listener.isCanceled())
            throw new SyncCancelException();
    ...
    public void upload(String localFilePath, String remoteFilePath) throws IllegalStateException, IOException, FTPIllegalReplyException, FTPException, FTPDataTransferException, FTPListParseException, SyncCancelException {
    ...
    public void upload(InputStream localFileStream, long localFileSize, String remoteFilePath) throws IllegalStateException, IOException, FTPIllegalReplyException, FTPException, FTPDataTransferException, FTPListParseException, SyncCancelException {
        try {
            String dir = Util.removeFilename(remoteFilePath);
    ...
    public boolean directoryExists(String dir) throws IllegalStateException, IOException, FTPIllegalReplyException, FTPException, FTPDataTransferException, FTPAbortedException, FTPListParseException {
