...
Data = {
  ...
  contains: (args)=>{return CSProActionInvoker.$Impl.run(this,48168,args);},
  ...
  getSyncStatus: (args)=>{return CSProActionInvoker.$Impl.run(this,36886,args);},
  getSyncStatusAsync: (args)=>{return CSProActionInvoker.$Impl.runAsync(this,36886,args);},
  ...
  query: (args)=>{return CSProActionInvoker.$Impl.run(this,13492,args);},
  queryAsync: (args)=>{return CSProActionInvoker.$Impl.runAsync(this,13492,args);},
  queryCases: (args)=>{return CSProActionInvoker.$Impl.run(this,23028,args);},
  queryCasesAsync: (args)=>{return CSProActionInvoker.$Impl.runAsync(this,23028,args);},
...
Network = {
  ...
  fetchFile: (args)=>{return CSProActionInvoker.$Impl.run(this,55689,args);},
  fetchFileAsync: (args)=>{return CSProActionInvoker.$Impl.runAsync(this,55689,args);},
...
Sync = {
  ...
  getConnectionInfo: (args)=>{return CSProActionInvoker.$Impl.run(this,59734,args);},
  getConnectionInfoAsync: (args)=>{return CSProActionInvoker.$Impl.runAsync(this,59734,args);},
...
UI = {
  ...
  setWebViewOptions: (args)=>{return CSProActionInvoker.$Impl.run(this,11210,args);},
  setWebViewOptionsAsync: (args)=>{return CSProActionInvoker.$Impl.runAsync(this,11210,args);},
