...
public:
    ...
    HTREEITEM InsertOrderFile(const CString& sOrderFileName, COrderDoc* pDoc);
    ...
    FormOrderAppTreeNode* GetFormOrderAppTreeNode(std::string_view file_path) const;

    BOOL OpenOrderFile(const std::string& order_file_path);
