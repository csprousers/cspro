...
namespace
{
    const FunctionDetails Functions[] =
    {
        ...
        {
            "getSyncStatus",
            "CS.Data.getSyncStatus([dataId := number | string, content := string, deviceId := string, deviceName := string, syncId := number])",
    ...
    const std::tuple<ActionInvoker::Action, const char*> JsonFunctionDefinitions[] =
    {
        ...
        { ActionInvoker::Action::Data_getSyncStatus,                  "{\"namespace\":\"Data\",\"name\":\"getSyncStatus\",\"description\":\"Returns information about the synchronization state of the data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"content\",\"description\":\"The type of status information to return. (Default value is \\\"summary\\\".)\",\"types\":[\"string\"],\"required\":false},{\"name\":\"deviceId\",\"description\":\"The device ID of a synchronization service, used to filter the content.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"deviceName\",\"description\":\"The device name of a synchronization service, used to filter the content.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"syncId\",\"description\":\"A synchronization service ID, with the service's device ID used to filter the content.\",\"types\":[\"number\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"An array or object containing the queried synchronization state.\",\"types\":[\"array\",\"object\"]}]}" },
