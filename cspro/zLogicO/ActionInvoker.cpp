...
namespace
{
    const FunctionDetails Functions[] =
    {
        ...
        {
            "writeCase",
            "CS.Data.writeCase(case := object[, dataId := number | string])",
    ...
    const std::tuple<ActionInvoker::Action, const char*> JsonFunctionDefinitions[] =
    {
        ...
        { ActionInvoker::Action::Data_writeCase,                      "{\"namespace\":\"Data\",\"name\":\"writeCase\",\"description\":\"Writes a case to a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"case\",\"description\":\"The case content.\",\"types\":[\"object\"],\"required\":true}]}" },
