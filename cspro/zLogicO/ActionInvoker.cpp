...
namespace
{
    ...
    const std::tuple<ActionInvoker::Action, const char*> JsonFunctionDefinitions[] =
    {
        ...
        { ActionInvoker::Action::Data_readCase,                       "{\"namespace\":\"Data\",\"name\":\"readCase\",\"description\":\"Returns a case read from a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"key\",\"description\":\"The key (case IDs) of a specific case to lookup.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"uuid\",\"description\":\"The UUID of a specific case to lookup. If both \\\"uuid\\\" and \\\"key\\\" are provided, the \\\"uuid\\\" value is prioritized.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"serializationOptions\",\"description\":\"Options for how the case should be serialized.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"The case.\",\"types\":[\"object\"]}]}" },
