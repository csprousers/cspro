...
namespace
{
    const FunctionDetails Functions[] =
    {
        ...
        {
            "countCases",
            "CS.Data.countCases([dataId := number | string, status := object, filter := object])",
        ...
        {
            "query",
            "CS.Data.query(content := string[, dataId := number | string, status := object, sort := object, filter := object, offset := number, limit := number, serializationOptions := object])",
            "CS_Data_query.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
        ...
        {
            "queryCases",
            "CS.Data.queryCases([dataId := number | string, status := object, sort := object, filter := object, offset := number, limit := number, serializationOptions := object])",
        ...
        {
            "queryKeys",
            "CS.Data.queryKeys([dataId := number | string, status := object, sort := object, filter := object, offset := number, limit := number])",
    ...
    const std::tuple<ActionInvoker::Action, const char*> JsonFunctionDefinitions[] =
    {
        ...
        { ActionInvoker::Action::Data_countCases,                     "{\"namespace\":\"Data\",\"name\":\"countCases\",\"description\":\"Counts the number of cases in a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"status\",\"description\":\"Options for the status of the cases to query. (Default value is \\\"notDeletedOnly\\\".)\",\"types\":[\"object\"],\"required\":false},{\"name\":\"filter\",\"description\":\"Options for how the queried data should be filtered.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"The number of cases.\",\"types\":[\"number\"]}]}" },
        { ActionInvoker::Action::Data_deleteCase,                     "{\"namespace\":\"Data\",\"name\":\"deleteCase\",\"description\":\"Deletes a case from a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"key\",\"description\":\"The key (case IDs) of a case.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"uuid\",\"description\":\"The UUID of a case. If both \\\"uuid\\\" and \\\"key\\\" are provided, the \\\"uuid\\\" value is prioritized.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"position\",\"description\":\"The \\\"position\\\" of the case in the data source.\",\"types\":[\"number\"],\"required\":false}]}" },
        ...
        { ActionInvoker::Action::Data_queryKeys,                      "{\"namespace\":\"Data\",\"name\":\"queryKeys\",\"description\":\"Queries case keys from a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"status\",\"description\":\"Options for the status of the cases to query. (Default value is \\\"notDeletedOnly\\\".)\",\"types\":[\"object\"],\"required\":false},{\"name\":\"sort\",\"description\":\"Options for how the queried data should be sorted.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"filter\",\"description\":\"Options for how the queried data should be filtered.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"offset\",\"description\":\"The number of case keys to skip before starting to return results from the query. (Default value is 0.)\",\"types\":[\"number\"],\"required\":false},{\"name\":\"limit\",\"description\":\"The maximum number of case keys to return from the query.\",\"types\":[\"number\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"An array containing the case keys.\",\"types\":[\"array\"]}]}" },
