...
namespace
{
    const FunctionDetails Functions[] =
    {
        ...
        },
        {
            ...
            "CS.Application.getQuestionnaireContent([name := string, key := string, uuid := string, position := number, serializationOptions := object])",
        ...
        {
            "contains",
            "CS.Data.contains([dataId := number | string, key := string, uuid := string, position := number])",
        ...
        {
            "countCases",
            "CS.Data.countCases([dataId := number | string, status := string, filter := object])",
            "CS_Data_countCases.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_countCases),
        },
        {
            "deleteCase",
            "CS.Data.deleteCase([dataId := number | string, key := string, uuid := string, position := number])",
            "CS_Data_deleteCase.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_deleteCase),
        },
        {
            "getCase",
        ...
        {
            "getSyncStatus",
            "CS.Data.getSyncStatus([dataId := number | string, content := string, deviceId := string, deviceName := string, syncId := number, key := string, uuid := string, position := number, universe := string, limit := number])",
            "CS_Data_getSyncStatus.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_getSyncStatus),
        },
        {
            "open",
            "CS.Data.open([connection := string | object, name := string, dictionary := string | object, openFlags := string])",
            "CS_Data_open.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
        ...
        {
            "query",
            "CS.Data.query(content := string[, dataId := number | string, status := string, sort := object, filter := object, limit := number, offset := number, serializationOptions := object])",
            "CS_Data_query.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_query),
        },
        {
            "queryCases",
            "CS.Data.queryCases([dataId := number | string, status := string, sort := object, filter := object, limit := number, offset := number, serializationOptions := object])",
            "CS_Data_queryCases.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_queryCases),
        },
        {
            "queryKeys",
            "CS.Data.queryKeys([dataId := number | string, status := string, sort := object, filter := object, limit := number, offset := number])",
            "CS_Data_queryKeys.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_queryKeys),
        },
        {
            "readCase",
            "CS.Data.readCase([dataId := number | string, key := string, uuid := string, position := number, serializationOptions := object])",
            "CS_Data_readCase.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
        ...
        {
            "sync",
            "CS.Data.sync([syncId := number, dataId := number | string, direction := string, universe := string | array])",
            "CS_Data_sync.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_sync),
        },
        {
            "writeCase",
            "CS.Data.writeCase(case := object[, dataId := number | string, replace := object])",
            "CS_Data_writeCase.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Data,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Data_writeCase),
        },
        ...
        {
            "getConnectionInfo",
            "CS.Sync.getConnectionInfo([syncId := number])",
            "CS_Sync_getConnectionInfo.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Sync,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Sync_getConnectionInfo),
        },
        {
            "sendMessage",
        ...
        {
            "syncData",
            "CS.Sync.syncData([syncId := number, dataId := number | string, direction := string, universe := string | array])",
            "CS_Sync_syncData.html",
            FunctionCode::CSFN_ACTIONINVOKER_CODE,
            FunctionNamespace::CS_Sync,
            DataType::String,
            FunctionCompilationType::CS,
            static_cast<int>(ActionInvoker::Action::Sync_syncData),
        },
        {
            "syncParadata",
    ...
    const std::tuple<ActionInvoker::Action, const char*> JsonFunctionDefinitions[] =
    {
        ...
        { ActionInvoker::Action::Data_close,                          "{\"namespace\":\"Data\",\"name\":\"close\",\"description\":\"Closes a previously opened data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false}]}" },
        { ActionInvoker::Action::Data_contains,                       "{\"namespace\":\"Data\",\"name\":\"contains\",\"description\":\"Returns whether a data source contains a specific case.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"key\",\"description\":\"The key (case IDs) of a case.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"uuid\",\"description\":\"The UUID of a case.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"position\",\"description\":\"The \\\"position\\\" of the case in the data source.\",\"types\":[\"number\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"True if the case exists.\",\"types\":[\"boolean\"]}]}" },
        { ActionInvoker::Action::Data_countCases,                     "{\"namespace\":\"Data\",\"name\":\"countCases\",\"description\":\"Returns the number of cases in a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"status\",\"description\":\"Options for the status of the cases to query. (Default value is \\\"notDeletedOnly\\\".)\",\"types\":[\"string\"],\"required\":false},{\"name\":\"filter\",\"description\":\"Options for how the queried data should be filtered.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"The number of cases.\",\"types\":[\"number\"]}]}" },
        { ActionInvoker::Action::Data_deleteCase,                     "{\"namespace\":\"Data\",\"name\":\"deleteCase\",\"description\":\"Deletes a case from a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"key\",\"description\":\"The key (case IDs) of a case.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"uuid\",\"description\":\"The UUID of a case.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"position\",\"description\":\"The \\\"position\\\" of the case in the data source.\",\"types\":[\"number\"],\"required\":false}]}" },
        { ActionInvoker::Action::Data_getCase,                        "{\"namespace\":\"Data\",\"name\":\"getCase\",\"description\":\"This action is deprecated. Use Data.getCurrentCase or Data.readCase instead.\",\"parameters\":[{\"name\":\"name\",\"description\":\"The name of a dictionary or form file associated with an application, or the name of an application.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"key\",\"description\":\"The key (case IDs) of a case.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"uuid\",\"description\":\"The UUID of a case.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"serializationOptions\",\"description\":\"Options for how the case should be serialized.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"The current case.\",\"types\":[\"object\"]}]}" },
        { ActionInvoker::Action::Data_getCurrentCase,                 "{\"namespace\":\"Data\",\"name\":\"getCurrentCase\",\"description\":\"Returns the current case associated with an application's dictionary.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"serializationOptions\",\"description\":\"Options for how the case should be serialized.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"The current case.\",\"types\":[\"object\"]}]}" },
        { ActionInvoker::Action::Data_getSyncStatus,                  "{\"namespace\":\"Data\",\"name\":\"getSyncStatus\",\"description\":\"Returns information about the synchronization state of the data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"content\",\"description\":\"The synchronization status content to query. (Default value is \\\"summary\\\".)\",\"types\":[\"string\"],\"required\":false},{\"name\":\"deviceId\",\"description\":\"The device ID of a synchronization service, used to filter the content.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"deviceName\",\"description\":\"The device name of a synchronization service, used to filter the content.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"syncId\",\"description\":\"A synchronization service ID, with the service's device ID used to filter the content.\",\"types\":[\"number\"],\"required\":false},{\"name\":\"key\",\"description\":\"The key (case IDs) of a specific case used to filter the content.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"uuid\",\"description\":\"The UUID of a specific case used to filter the content.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"position\",\"description\":\"The \\\"position\\\" of a specific case used to filter the content.\",\"types\":[\"number\"],\"required\":false},{\"name\":\"universe\",\"description\":\"A universe to limit the cases that are considered as part of a synchronization status query.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"limit\",\"description\":\"The maximum number of results to return from the query.\",\"types\":[\"number\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"An array or object containing the queried synchronization state.\",\"types\":[\"array\",\"object\"]}]}" },
        { ActionInvoker::Action::Data_open,                           "{\"namespace\":\"Data\",\"name\":\"open\",\"description\":\"Opens a data source and returns an ID that can be used for future operations.\",\"parameters\":[{\"name\":\"connection\",\"description\":\"The connection string specifying the data source. Either \\\"connection\\\" or \\\"name\\\" must be specified.\",\"types\":[\"string\",\"object\"],\"required\":false},{\"name\":\"name\",\"description\":\"The name of a dictionary. Either \\\"connection\\\" or \\\"name\\\" must be specified.\",\"types\":[\"string\"],\"required\":false},{\"name\":\"dictionary\",\"description\":\"The dictionary that describes the data source's cases (when using a \\\"connection\\\"). It can be a dictionary name, path, or the JSON contents of a dictionary.\",\"types\":[\"string\",\"object\"],\"required\":false},{\"name\":\"openFlags\",\"description\":\"Flags to control how the data source is opened (when using a \\\"connection\\\"). (Default value is \\\"read\\\".)\",\"types\":[\"string\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"An ID that identifies this data source.\",\"types\":[\"number\"]}]}" },
        { ActionInvoker::Action::Data_query,                          "{\"namespace\":\"Data\",\"name\":\"query\",\"description\":\"Queries content from a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"content\",\"description\":\"The content to query.\",\"types\":[\"string\"],\"required\":true},{\"name\":\"status\",\"description\":\"Options for the status of the cases to query. (Default value is \\\"notDeletedOnly\\\".)\",\"types\":[\"string\"],\"required\":false},{\"name\":\"sort\",\"description\":\"Options for how the queried data should be sorted.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"filter\",\"description\":\"Options for how the queried data should be filtered.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"limit\",\"description\":\"The maximum number of results to return from the query.\",\"types\":[\"number\"],\"required\":false},{\"name\":\"offset\",\"description\":\"The number of results to skip before starting to return results from the query. (Default value is 0.)\",\"types\":[\"number\"],\"required\":false},{\"name\":\"serializationOptions\",\"description\":\"Options for how cases should be serialized.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"A count or an array containing the query results.\",\"types\":[\"number\",\"array\"]}]}" },
        { ActionInvoker::Action::Data_queryCases,                     "{\"namespace\":\"Data\",\"name\":\"queryCases\",\"description\":\"Queries cases from a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"status\",\"description\":\"Options for the status of the cases to query. (Default value is \\\"notDeletedOnly\\\".)\",\"types\":[\"string\"],\"required\":false},{\"name\":\"sort\",\"description\":\"Options for how the queried data should be sorted.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"filter\",\"description\":\"Options for how the queried data should be filtered.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"limit\",\"description\":\"The maximum number of cases to return from the query.\",\"types\":[\"number\"],\"required\":false},{\"name\":\"offset\",\"description\":\"The number of cases to skip before starting to return results from the query. (Default value is 0.)\",\"types\":[\"number\"],\"required\":false},{\"name\":\"serializationOptions\",\"description\":\"Options for how cases should be serialized.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"An array containing the cases.\",\"types\":[\"array\"]}]}" },
        { ActionInvoker::Action::Data_queryKeys,                      "{\"namespace\":\"Data\",\"name\":\"queryKeys\",\"description\":\"Queries case keys from a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"status\",\"description\":\"Options for the status of the cases to query. (Default value is \\\"notDeletedOnly\\\".)\",\"types\":[\"string\"],\"required\":false},{\"name\":\"sort\",\"description\":\"Options for how the queried data should be sorted.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"filter\",\"description\":\"Options for how the queried data should be filtered.\",\"types\":[\"object\"],\"required\":false},{\"name\":\"limit\",\"description\":\"The maximum number of case keys to return from the query.\",\"types\":[\"number\"],\"required\":false},{\"name\":\"offset\",\"description\":\"The number of case keys to skip before starting to return results from the query. (Default value is 0.)\",\"types\":[\"number\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"An array containing the case keys.\",\"types\":[\"array\"]}]}" },
        ...
        { ActionInvoker::Action::Data_sync,                           "{\"namespace\":\"Data\",\"name\":\"sync\",\"description\":\"Synchronizes the cases in a data source with a synchronization service.\",\"parameters\":[{\"name\":\"syncId\",\"description\":\"The synchronization service ID.\",\"types\":[\"number\"],\"required\":false},{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"direction\",\"description\":\"The synchronization direction. (Default value is \\\"both\\\".).\",\"types\":[\"string\"],\"required\":false},{\"name\":\"universe\",\"description\":\"A universe that restricts cases transfered to cases with keys starting with the universe.\",\"types\":[\"string\",\"array\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"Information about the number of cases involved in the synchronization.\",\"types\":[\"object\"]}]}" },
        { ActionInvoker::Action::Data_writeCase,                      "{\"namespace\":\"Data\",\"name\":\"writeCase\",\"description\":\"Writes a case to a data source.\",\"parameters\":[{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"case\",\"description\":\"The case content.\",\"types\":[\"object\"],\"required\":true},{\"name\":\"replace\",\"description\":\"Details about where to write the case in the data source if overwriting an existing case.\",\"types\":[\"object\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"The \\\"position\\\" of the written case in the data source (if known).\",\"types\":[\"number\"]}]}" },
        ...
        { ActionInvoker::Action::Sync_getConnectionInfo,              "{\"namespace\":\"Sync\",\"name\":\"getConnectionInfo\",\"description\":\"Returns information about the synchronization service connection.\",\"parameters\":[{\"name\":\"syncId\",\"description\":\"The synchronization service ID.\",\"types\":[\"number\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"Information about the connection.\",\"types\":[\"object\"]}]}" },
        ...
        { ActionInvoker::Action::Sync_syncData,                       "{\"namespace\":\"Sync\",\"name\":\"syncData\",\"description\":\"Synchronizes the cases in a data source with a synchronization service.\",\"parameters\":[{\"name\":\"syncId\",\"description\":\"The synchronization service ID.\",\"types\":[\"number\"],\"required\":false},{\"name\":\"dataId\",\"description\":\"The data source ID or the name of a dictionary.\",\"types\":[\"number\",\"string\"],\"required\":false},{\"name\":\"direction\",\"description\":\"The synchronization direction. (Default value is \\\"both\\\".).\",\"types\":[\"string\"],\"required\":false},{\"name\":\"universe\",\"description\":\"A universe that restricts cases transfered to cases with keys starting with the universe.\",\"types\":[\"string\",\"array\"],\"required\":false}],\"returns\":[{\"name\":\"\",\"description\":\"Information about the number of cases involved in the synchronization.\",\"types\":[\"object\"]}]}" },
