...
namespace Logic { class RecommendedWordCalculator; }


class Logic::RecommendedWordCalculator
{
public:
    ...
    RecommendedWordCalculator(const std::string& word, const double min_score_required = MinRequiredScore)
    ...
    std::string GetRecommendedWord() const
    {
...
private:
    FuzzyWuzzy::BestMatchProcessor m_fuzzyMatcher;
};
