This is ~~RELEASE_PREFIX~~ release of the [Census and Survey Processing System (CSPro)](https://www.census.gov/data/software/cspro.html), version ~~VERSION_FULL~~.

Useful links:

- [What's New in CSPro ~~VERSION_MAJOR~~.~~VERSION_MINOR~~?](https://csprousers.org/help/CSPro/what_is_new_in_cspro_~~VERSION_MAJOR~~_~~VERSION_MINOR~~.html)
- [CSPro Documentation](https://csprousers.org/help/CSPro/)
