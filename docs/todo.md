# CSPro Incomplete Work

Some long-running development projects are identifiable by a TODO noted in comments. The following table describes some of the incomplete work:

| TODO | Work |
| --- | --- |
| APP_LOAD_TODO | Refactoring how applications are loaded.
| BATCH_FLOW_TODO | Refactoring related to batch application flow.
| BINARY_TYPES_TO_ENGINE_TODO | Ability to use binary data in the engine.
| BLOCK_TODO | Related to form blocks.
...
| CS_TODO | Related to the Action Invoker.
| CSWEB_TODO | Related to the CSWeb Data Source.
